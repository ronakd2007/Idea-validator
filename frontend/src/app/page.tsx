...
// The 3D landing is a large client-only chunk (three.js + react-three-fiber).
// While it downloads, visitors previously stared at a blank page — this static
// fallback paints the headline and CTAs instantly, so the page feels alive
// even on a slow connection, then the scene takes over seamlessly.
